  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        primaryEntityId: "switch.midea_washer_power",
        entities: [
          { entityId: "switch.midea_washer_power", label: "Power", icon: "⚡" },
          { entityId: "sensor.midea_washer_status", label: "Status", icon: "📊" },
          { entityId: "sensor.midea_washer_remaining_time", label: "Remaining", icon: "⏳" },
          { entityId: "select.midea_washer_mode", label: "Cycle", icon: "🔄" },
        ],
      },
    ],
  },
