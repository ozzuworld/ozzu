      ...
      <View style={{ flex: 1, backgroundColor: "rgba(0,0,0,0.6)", justifyContent: "flex-end" }}>
        <View style={{ backgroundColor: colors.gray[850], borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: "85%" }}>
          <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: 16, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.06)" }}>
            <Text style={{ color: colors.gray[50], fontFamily: "monospace", fontSize: 14, fontWeight: "bold" }}>New Contact</Text>
          ...
          <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 40 }}>
            ...
            <Pressable
              ...
              style={{
                backgroundColor: name.trim() ? ACCENT : colors.gray[600],
                borderRadius: 10, padding: 14, alignItems: "center", marginTop: 8,
                opacity: name.trim() ? 1 : 0.5,
              }}
            >
              <Text style={{ color: colors.gray[850], fontFamily: "monospace", fontSize: 13, fontWeight: "bold" }}>{saving ? "Creating..." : "CREATE CONTACT"}</Text>
            </Pressable>
          </ScrollView>
        </View>
      </View>
