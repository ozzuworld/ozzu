...
// dir_1782242371780 (correction): relative require so this module also loads outside
// the Docker container (e.g. the test suite) — '/app/db' and './db' are the same file
// in the bridge image (WORKDIR /app), matching offense-agent.js's existing `./db`.
const db = require("./db");
