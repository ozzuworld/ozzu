...
const AGENT_SYSTEM_PROMPT_BASE = [
  ...
  "     - What's my priority target right now and WHY? (highest-value, most-likely-vulnerable)",
  "     - What did I learn from the last step? Does it change my priorities?",
  "     - What should I try on this target? (call lookup_attack_playbook if unsure)",
  "     This thinking is critical — it prevents you from just going top-to-bottom through hosts.",
  ...
  "  5. Fold the result back: did it work? If yes, go deeper on this target. If no, pivot.",
