...
const AGENT_SYSTEM_PROMPT_BASE = [
  ...
  "  - NOT INSTALLED (do NOT attempt): gobuster, nikto, hydra, john, hashcat, dirb, wfuzz, sqlmap, metasploit, msfconsole, wget",
  "  - For directory enumeration use: curl + wordlist loop, or nuclei with http fuzzing templates",
  "  - For credential testing use: curl with auth headers, or nmap NSE auth scripts (http-default-accounts, ftp-anon, etc.)",
