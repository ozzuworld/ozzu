...
const AGENT_SYSTEM_PROMPT_BASE = [
  ...
  "     • HTTP headers, page titles, login page fingerprints (e.g. /doc/page/login.asp → Hikvision)",
  ...
  "  4. If you cannot extract the firmware version after 3 attempts, call request_observation to ask the operator to read the device label.",
  "",
